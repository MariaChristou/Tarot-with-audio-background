Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        My.Computer.Audio.Play(My.Resources._1_Hour_of_Creepy_Doll_Music__1_, AudioPlayMode.BackgroundLoop)
...
There will be a new begging...you must make the best of it...It is a time you lived your life to the fullest and tried to accomplish new goals! "
...
You will have a epiphany or an 'awakening' where you will come to realisation that you need to live your life in a different way and you need to be true to yourself and your needs!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 3 Then
...
You will give others space and you were tolerant of their needs...You will accept and forgive any imperfections...You will create a safe and trusting enviroment where you could gently influence others!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 5 Then
            TextBox3.Text = "DEATH:
...
You may be tricked into believing that you were being cotrolled by external forces when in fact have created your own chains of imprisonment and powerlessness!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 8 Then
...
You will have a strong desire to see your ideas manifested on the physical plane and the emperor will ensure to see it out until the end!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 11 Then
            TextBox3.Text = "THE HANGED MAN:
You will have a need to get in touch with why you are feeling this way and worked to release yourself from these restrictions!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 12 Then
...
You will desire a new direction in life and have recently begun a journey of self-discovery and contemplation!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 14 Then
            TextBox3.Text = "THE LOVERS:
There will be a time when you will figure out what you stand foramd what your personal philosophy on life is!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 15 Then
            TextBox3.Text = "THE MAGICIAN:
You will hve the need to know what you are doing and why you are doing it...You will need to be clear adout your underlying motives and intetions!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 16 Then
            TextBox3.Text = "THE MOON:
You will experience negative blocks within your personality, causing fear and anxiety"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 17 Then
...
You will be able able to work in harmony with others and there is a heightened level of co-operation in your activities with others!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 18 Then
            TextBox3.Text = "THE SUN:
No matter where you go or what you do your positive and radiant energy will follow you and bring you happiness and joy! "
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 20 Then
            TextBox3.Text = "THE TOWER:
There will be a time of great turmoil and destruction as you seek to understand how you could have been so wrong, so naive, or so blind about a particularly situation!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4 = 21 Then
            TextBox3.Text = "THE WHEEL OF FORTUNE:
There will be a time when you need to remain optimistic yourself,thinking positively and keeping upbeat as possible!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        ElseIf num4= 22 Then
            TextBox3.Text = "THE WORLD:
All of your efforts will finally pay off and you will reach the end of a journey or had completed a major live cyrcle!"
            TextBox3.TextAlign = HorizontalAlignment.Center
        End If
    End Sub
